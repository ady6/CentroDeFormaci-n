...
// para seleccionar a los alumnos aceptados ordenados por apellido ascendente

$select="SELECT * FROM hito1.alumnos WHERE ACEPTADO=1 ORDER BY APELLIDOS ASC";
...
<table>
  <h3>Listado de los alumnos aceptados:</h3>
  <thead>
  	<tr>
      <th>DNI</th>
      <th>Nombre</th>
